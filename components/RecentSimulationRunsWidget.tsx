...
export function RecentSimulationRunsWidget({ take = 5 }: { take?: number }) {
  ...
  return (
    <section className="rounded-xl border border-zinc-800 bg-zinc-900/80 p-5">
      ...
      {runs === null ? (
        ...
        <p className="mt-4 text-sm text-zinc-400">No runs have been saved yet.</p>
      ) : (
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-zinc-500">
                    ...
                    {run.assumptionsVersion ? ` � ${run.assumptionsVersion}` : ""}
                  </p>
                </div>
